...
function hienthitaikhoan()
{
	if(localStorage.taikhoanhientai)
	{
		...
		var hoten = "hoten"+i;
		var s = '<div  style="float:left; padding:10px 2px;width:70%; position:static;color:red;text-align:center;"><strong style="font-size:25px;">'+localStorage.getItem(hoten)+'</strong></div>'+
